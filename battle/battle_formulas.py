# Type multiplier and damage formulas

def min_type_multiplier(
        firstEffectivness: float,
        secondEffectivness: float) -> float:
    return min(firstEffectivness, secondEffectivness)


def max_type_multiplier(
        firstEffectivness: float,
        secondEffectivness: float) -> float:
...
def damage_attack_minus_defense(
    ...
    return (
        int(round((combined_attack * type_multiplier) - combined_defense, 1))
    )
...
def damage_attack_devide_defense(
    ...
    return (
        int(round((combined_attack / combined_defense) * type_multiplier, 1))
    )
